...
> **Offen D (eigener writing-plans→exec-Zyklus):** D = API-Contract/schemathesis (⚠️ braucht OpenAPI-Specs pro App = größter Brocken, App-Code-Folgearbeit außerhalb der CI-Spur).
>
